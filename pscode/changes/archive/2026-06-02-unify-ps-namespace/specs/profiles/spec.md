...
**Reason**: `grill-me` deixa de ser um workflow gerador de comando; passa a ser uma skill auto-invocada sempre presente, não controlada pela lista de workflows do perfil.
**Migration**: A skill `pscode-grill-me` continua sendo gerada em ambos os perfis (ver capability `grill-me-skill`); apenas o comando `/ps:grill-me` é removido.
