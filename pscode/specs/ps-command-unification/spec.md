# Spec: ps-command-unification

## Purpose

Define a unificação de toda a superfície de slash commands sob o namespace único
`/ps:*`, eliminando `/pstld:*`. Ambos os perfis (`standard` e `dixi`) expõem a mesma
lista de comandos, divergindo apenas no comportamento via overrides de conteúdo.
