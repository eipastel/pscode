...
No loop de refinamento do skill `ps:propose`, o card do Trello é atualizado com o conteúdo do refinamento (descrição e comentário) **antes** de o usuário ser questionado se o planejamento está de acordo. Isso permite que o card sirva como referência visual na decisão de aprovação, em vez de ser atualizado apenas após a aprovação.
