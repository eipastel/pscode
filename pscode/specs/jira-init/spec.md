...
Defines the JIRA integration files generated when `pscode init --profile dixi` is executed. Covers creation of `pastelsdd/jira.yaml` with project configuration fields and merge of the Atlassian MCP entry into `.mcp.json`.
