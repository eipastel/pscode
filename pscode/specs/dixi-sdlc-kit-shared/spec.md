...
Defines the shared SDLC kit files installed by `installDixiExtras` for all Dixi-enabled projects regardless of stack family. These files enforce cross-cutting conventions (commit format, PR standards) that apply to every project.
