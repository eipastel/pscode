...
Define os 5 slash commands `/pstld:*` fornecidos pelo profile dixi do pscode. Cada comando é um arquivo markdown em `pscode/content/dixi/claude-runtime/commands/` que o Claude Code expõe como skill após a instalação via `installDixiExtras`.
