...
describe('ZshGenerator', () => {
  ...
  describe('generate', () => {
    it('should generate valid zsh completion script with header', () => {
      ...
      expect(script).toContain('#compdef pscode');
      expect(script).toContain('# Zsh completion script for Pscode CLI');
      expect(script).toContain('_pscode() {');
    });
    ...
    it('should include all commands in the command list', () => {
      ...
      expect(script).toContain("'init:Initialize Pscode'");
    ...
    it('should generate command completion functions', () => {
      ...
      expect(script).toContain('_pscode_init() {');
      expect(script).toContain('_pscode_validate() {');
    });
    ...
    it('should handle commands with subcommands', () => {
      ...
      expect(script).toContain('_pscode_change_show() {');
      expect(script).toContain('_pscode_change_list() {');
    });
    ...
    it('should handle positional arguments for change-id', () => {
      ...
      expect(script).toContain("'*: :_pscode_complete_changes'");
    });
    ...
    it('should handle positional arguments for spec-id', () => {
      ...
      expect(script).toContain("'*: :_pscode_complete_specs'");
    });
    ...
    it('should handle positional arguments for change-or-spec-id', () => {
      ...
      expect(script).toContain("'*: :_pscode_complete_items'");
    });
    ...
    it('should handle positional arguments for schema names', () => {
      ...
      expect(script).toContain("'*: :_pscode_complete_schemas'");
      expect(script).toContain('_pscode_complete_schemas()');
    });
    ...
    it('should sanitize command names with hyphens for function names', () => {
      ...
      expect(script).toContain('_pscode_my_command() {');
    });
    ...
    it('should handle complex nested subcommands with flags', () => {
      ...
      expect(script).toContain('_pscode_spec() {');
      expect(script).toContain('_pscode_spec_validate() {');
      expect(script).toContain('--strict');
      expect(script).toContain('--json');
      expect(script).toContain("'*: :_pscode_complete_specs'");
    });
    ...
    it('should generate script that ends with compdef registration', () => {
      ...
      expect(script.trim().endsWith('compdef _pscode pscode')).toBe(true);
    });
    ...
    it('should handle commands with no flags', () => {
      ...
      expect(script).toContain('_pscode_view() {');
