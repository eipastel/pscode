...
export function getGrillMeSkillTemplate(): SkillTemplate {
  return {
    ...
    description:
      'Interroga um plano antes da implementação — uma pergunta por vez, com resposta recomendada, explorando o código quando há evidência, até entendimento compartilhado. Use quando o usuário quer validar e refinar um plano antes de escrever artefatos ou código.',
...
export function getGrillMeInstructions(): string {
